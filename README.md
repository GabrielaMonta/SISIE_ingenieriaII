...
Este proyecto corresponde al desarrollo del módulo de envíos para la cátedra de Ingeniería del Software II (SISIE).
...
1. Ejecutar el archivo `script_usuario.sql` en tu servidor SQL Server.
